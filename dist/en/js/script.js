...
(function () {
  ...
  function calculateFeature(ev) {
    ...
    $input[0].value = getVariablePrice($input[0].name, currency, $input[0], $input[0].value, operator);
  ...
  function switchButton(ev) {
    ...
    if (currentVisibleClassName === "add") $input[0].value = getFixedPrice($input[0].name, currency);else $input[0].value = 0;
